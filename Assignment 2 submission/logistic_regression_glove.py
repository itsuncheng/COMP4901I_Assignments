...
from preprocess_glove import data_preprocess, feature_extraction_embedding, normalization, loadGloveModel
...
if __name__ == "__main__":
    ...
    word_emb_mat, word2idx = loadGloveModel("glove.6B.300d.txt")
    revs = data_preprocess('./twitter-sentiment.csv', args['clean'], int(args['max_vocab']))
    ...
    revs = data_preprocess("./twitter-sentiment-testset.csv", args['clean'], int(args['max_vocab']))
