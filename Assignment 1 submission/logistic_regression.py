...
if __name__ == "__main__":
    ...
    parser.add_argument('-ng','--ngram', help='value of ngram', required=False, default=1) # Added for ngram
    ...
    revs, word2idx = data_preprocess('./twitter-sentiment.csv', args['clean'], int(args['max_vocab']), int(args['ngram']))
    ...
    revs, _ = data_preprocess("./twitter-sentiment-testset.csv", args['clean'], int(args['max_vocab']), int(args['ngram']))
    test_data, _ = feature_extraction_bow(revs, word2idx, int(args['ngram']))
